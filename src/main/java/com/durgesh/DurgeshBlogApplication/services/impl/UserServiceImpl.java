...
import com.durgesh.DurgeshBlogApplication.repositories.UserRepo;
import com.durgesh.DurgeshBlogApplication.services.UserService;
import com.durgesh.DurgeshBlogApplication.exception.*;
...
public class UserServiceImpl implements UserService{
	...
	public UserDto updateUser(UserDto userDto, Integer userId) {
		...
		user.setPassword(userDto.getPassoword());
...
//		userDto.setPassoword(user.getPassword());
//		return userDto;
//		
//		
//	}
